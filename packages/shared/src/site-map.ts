...
export const SITE_PAGES: SitePageEntry[] = [
  ...
  { id: "wire-node-apply", path: "/protocol/wire-node/apply", section: "protocol", readiness: "live" },
  { id: "protocol-governance", path: "/protocol/governance", section: "protocol", readiness: "live" },
  { id: "wire-node-review", path: "/protocol/wire-node/review", section: "protocol", readiness: "live" },
