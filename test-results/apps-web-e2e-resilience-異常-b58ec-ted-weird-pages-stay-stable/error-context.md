...
- Name: apps/web/e2e/resilience.spec.ts >> 異常系 — 認証済み abuse >> authenticated weird pages stay stable
- Location: apps/web/e2e/resilience.spec.ts:245:7
...
Call log:
  - navigating to "/mypage", waiting until "domcontentloaded"
