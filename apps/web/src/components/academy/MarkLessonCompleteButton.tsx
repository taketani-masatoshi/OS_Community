...
type AcademyLabels = Pick<
  PageMessages["academy"],
  "markLessonComplete" | "markLessonDone" | "savingProgress" | "saveProgressFailed"
>;
...
export function MarkLessonCompleteButton({
  ...
  if (done) {
    return <p className="academy-progress-done">{labels.markLessonDone}</p>;
  }
  ...
  return (
    <div className="academy-progress-actions">
      ...
      >
        {loading ? labels.savingProgress : labels.markLessonComplete}
      </button>
